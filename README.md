...
3. Ajoutez cette URL aux "URLs supplémentaires de gestionnaires de cartes" :
   ```
   https://raw.githubusercontent.com/espressif/arduino-esp32/gh-pages/package_esp32_index.json
   ```
4. **Outils > Carte > Gestionnaire de cartes**
5. Recherchez et installez **ESP32**

#### Téléchargement du code
1. Ouvrez `esp32/ESP32_RC_Controller.ino`
2. Sélectionnez la carte : **ESP32S2 Dev Module**
3. Sélectionnez le port COM approprié
4. Cliquez **Téléverser** (flèche ▶️)
...
1. Ouvrez le dossier `android/` comme projet
2. Cliquez **Run > Run 'app'**
3. Sélectionnez votre appareil Android
...
- [**API.md**](docs/API.md) : Documentation du protocole BLE
...
- **Votre Nom** - [GitHub Profile](https://github.com/VOTRE_USERNAME)

## 📞 Support

Pour des questions ou des problèmes, ouvrez une [issue GitHub](https://github.com/VOTRE_USERNAME/rc-car-ble-controller/issues).
